...
myPlane.prototype.move = function(state){
	...
	_this.stage.onmouseover = function (e) {
		...
		_this.stage.onmousemove = function (e) {
			...
			if (_this.plane.offsetTop > _this.offsetHeight - _this.plane.offsetHeight) {
				_this.plane.style.top = _this.stage.offsetHeight - this.plane.offsetHeight + "px";
			}
			
		}
		
		_this.stage.onmousemout = function () {
